...
def worker(msg):
    ...
    image_file_metadata_filename = 'data/input_samples_annotations.txt'
    image_files_metadata = pd.read_csv(image_file_metadata_filename, sep=',', skiprows=range(1, shard_index*shard_length+1), nrows=shard_length)
