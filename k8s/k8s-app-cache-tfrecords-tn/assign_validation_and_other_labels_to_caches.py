...
validation_percentage = int(os.environ['training_percentage'])
testing_percentage = int(os.environ['testing_percentage'])
lstrip_string = 'gs://' + bucket_name + '/'
temp_path = sys.argv[1]

cache_df = choose_input_list.assign_validation_and_other_labels_to_tiles(training_percentage = training_percentage,
